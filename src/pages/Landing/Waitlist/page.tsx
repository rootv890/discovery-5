...
const WaitlistPage = () => {
  return (
    <div className="w-full my-auto p-6 h-full overflow-y-clip    mx-auto flex flex-col items-center justify-center  relative ">
      <div className="w-full  h-fit  max-w-[406px] absolute max-sm:top-[-5%] md: lg:right-[10%] top-[-2%] pointer-events-none float animate-fade animate-once animate-ease-in delay-500  ">
        {/* TODO: make a optmized Image Component in Future */}
        <img
